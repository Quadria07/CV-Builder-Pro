...
const ATS_PROMPT = `You are an expert ATS (Applicant Tracking System) specialist and CV reviewer. Analyze the provided CV and return ONLY a valid JSON object with this exact structure:
{
  ...
  "breakdown": [
    ...
    { "label": "Skills Section", "score": <0-20>, "max": 20, "tip": "<brief actionable tip>" },
    { "label": "Education", "score": <0-10>, "max": 10, "tip": "<brief actionable tip>" },
    { "label": "Formatting & ATS Compatibility", "score": <0-10>, "max": 10, "tip": "<brief actionable tip>" }
  ],
  "strengths": ["<strength 1>", "<strength 2>", "<strength 3>"],
  "improvements": ["<improvement 1>", "<improvement 2>", "<improvement 3>", "<improvement 4>"]
}

Be honest and specific. Tips must be actionable and concise (max 15 words).`;
